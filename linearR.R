...
fitted(fit2)# predicted values for input price and promotion
omni$sales
residuals(fit2)#diff between the predicted and actual sales
...
(ndata2 = data.frame(price=c(60,70,72), promotion=c(300,350,400)))
